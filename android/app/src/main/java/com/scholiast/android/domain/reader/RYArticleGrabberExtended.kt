/*
 * Vendored from Read You (https://github.com/Ashinch/ReadYou),
 * app/src/main/java/me/ash/reader/infrastructure/html/RYArticleGrabberExtended.kt.
 * Copyright (C) 2022 Ashinch / Read You contributors.
 *
 * Licensed under the GNU General Public License v3.0 (GPL-3.0):
 * https://www.gnu.org/licenses/gpl-3.0.html
 *
 * Repackaged from `me.ash.reader.infrastructure.html` to
 * `com.scholiast.android.domain.reader`; otherwise unmodified. Kept as a subclass of the
 * library's own `ArticleGrabberExtended` so the extended Readability pipeline behaves
 * exactly as it does in Read You. Personal/sideloaded distribution posture (same as the
 * vendored FUTO whisper.cpp engine).
 */
