# 03: Mobile UI Adaptation & Safe Areas

**What to build:** Mobile UI Adaptation & Safe Areas

**Blocked by:** 02

**Status:** completed

- [x] Responsive phone/tablet views with status bar padding and touch ergonomics (Invariants 1, 2)
