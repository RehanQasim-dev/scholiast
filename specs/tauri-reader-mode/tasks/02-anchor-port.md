# 02: Anchor Port & Cross-Surface Parity

**What to build:** Anchor Port & Cross-Surface Parity

**Blocked by:** 01

**Status:** completed

- [x] shared/anchor.ts ported into frontend with test vector validation (Invariant 4)
